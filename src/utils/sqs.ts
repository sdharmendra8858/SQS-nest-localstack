import { 
    ...
    SendMessageCommandOutput } from "@aws-sdk/client-sqs";
...
class SqsService {
    ...
    public async deleteQueue(queueUrl: string): Promise<DeleteQueueCommandOutput> {
        try{
    ...
    public async publishMessage(queueUrl: string, msgGroupId: string, message: string, attributes?: Record<string, any>): Promise<SendMessageCommandOutput> {
        try{
            console.log(`Sending the message with : ${message}, ${JSON.stringify(attributes)}`);
    ...
    public async receiveMessage(queueUrl: string): Promise<ReceiveMessageCommandOutput>{
        try{
    ...
    public async deleteMessage(queueUrl: string, receiptHandler: string): Promise<DeleteMessageCommandOutput> {
        try{
